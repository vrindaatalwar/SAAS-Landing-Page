  ...
  <div className="w-full h-48 bg-slate-50 rounded-2xl border border-slate-100 flex items-center justify-center p-6 group cursor-default">
    <div className="w-full p-4 bg-white rounded-xl shadow-sm border border-slate-100 relative overflow-hidden">
      ...
      <div className="flex items-start gap-3 mb-4">
        ...
        <div>
          <p className="text-[10px] font-mono text-slate-400 mb-1">#112</p>
...
const ValueProp = () => {
  ...
  // Exclusive Perpetual Focus with Smooth Cross-fades
  // 0.5s transition window between 2s stages
        ...
        <div className="max-w-4xl mb-32">
          ...
          >
            ...
            <motion.span variants={line1Variants} className="block">
              ...
              <sup className="text-[10px] font-mono opacity-50 ml-1">01</sup>
              {' '} issues in your app,
            </motion.span>
            ...
            <motion.span variants={line2Variants} className="block">
              ...
              <sup className="text-[10px] font-mono opacity-50 ml-1">02</sup>
            ...
            <motion.span variants={line3Variants} className="block">
              ...
              <sup className="text-[10px] font-mono opacity-50 ml-1">03</sup>
        ...
        >
          ...
          >
            ...
            >
              <MockupOne />
              <div className="mt-10">
                <span className="text-[10px] font-mono text-slate-400 mb-4 block">01</span>
          ...
          >
            ...
            >
              <MockupTwo />
              <div className="mt-10">
                <span className="text-[10px] font-mono text-slate-400 mb-4 block">02</span>
          ...
          >
            ...
            >
              <MockupThree />
              <div className="mt-10">
                <span className="text-[10px] font-mono text-slate-400 mb-4 block">03</span>
