  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-[100] flex items-center justify-between px-8 py-[12.6px] bg-white/70 backdrop-blur-xl border-b border-slate-100">
      ...
      <div className="flex-1 flex items-center justify-end gap-5">
        ...
        <button className="px-5 py-2.5 bg-black text-white text-[13px] font-black rounded-xl hover:bg-slate-800 transition-all flex items-center gap-2 shadow-lg shadow-black/10 active:scale-95">
