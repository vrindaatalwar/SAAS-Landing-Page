    ...
    <section className="pt-8 pb-32 px-6 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between mb-20">
           <div>
              <p className="text-[10px] font-bold text-slate-400 tracking-[0.2em] uppercase mb-4">Changelog</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 border-t border-slate-100 pt-12">
          {updates.map((update, index) => (
             ...
             >
                <div className="text-[10px] font-bold text-slate-400 tracking-[0.1em] mb-6">{update.date}</div>
