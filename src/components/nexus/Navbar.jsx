...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-[100] flex items-center justify-between px-8 py-3 bg-white/70 backdrop-blur-xl border-b border-slate-100">
      ...
      <div className="flex-1 flex items-center justify-end gap-[18px]">
        ...
        >
          Request a demo <span className="opacity-30 text-[8px] font-normal">D</span>
        </button>
      </div>
    </nav>
  );
