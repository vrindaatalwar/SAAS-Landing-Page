            ...
            {step === 1 ? (
                ...
                <FieldGroup>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <Field>
                      ...
                      <Input id="firstName" placeholder="John" required className="h-11 rounded-xl" />
                    </Field>
                    <Field>
                      <FieldLabel htmlFor="lastName">Last Name</FieldLabel>
                      <Input id="lastName" placeholder="Doe" required className="h-11 rounded-xl" />
                    </Field>
                  </div>
                  ...
                  <Field>
                    ...
                    <Input id="password" placeholder="••••••••" type="password" required className="h-11 rounded-xl" />
                  </Field>

                  <Field>
                    <FieldLabel htmlFor="confirmPassword">Confirm Password</FieldLabel>
                    <Input id="confirmPassword" placeholder="••••••••" type="password" required className="h-11 rounded-xl" />
                  </Field>
                  ...
                  <Field>
                    ...
                    <FieldDescription className="text-center mt-6">
                      ...
                      <a href="/login" className="font-bold text-slate-900 hover:underline underline-offset-4">
                        Login
                      </a>
                    </FieldDescription>
                  </Field>
              ...
              <div className="flex flex-col items-center gap-6 text-center animate-in fade-in zoom-in duration-500">
                ...
                <div className="space-y-2">
                  <h1 className="text-3xl font-bold tracking-tight text-slate-900">Account created!</h1>
